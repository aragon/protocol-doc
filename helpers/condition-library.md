...
- **[SelectorCondition](./condition-library/selector-condition.md)** — allow only a set of function **selectors** on the *direct call* being authorized. "This permission, but only to call functions X and Y."
...
- [SelectorCondition](./condition-library/selector-condition.md), [ExecuteSelectorCondition](./condition-library/execute-selector-condition.md), [SafeOwnerCondition](./condition-library/safe-owner-condition.md) — the three, each in depth.
