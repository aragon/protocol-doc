...
Understand the [plugin framework](../framework/index.md), and [what a plugin and its setup are](../framework/plugin-types.md), before the [template](./plugin-template.md) (how to scaffold one). Step-by-step [guides](../guides/index.md) that turn this into a walkthrough are planned (not yet written).
