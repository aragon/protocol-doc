...
- [Plugins](/framework/plugins.md) — the shared plugin model.
- [Plugin setup](/framework/plugin-setup.md) — the matching setup base for each type.
