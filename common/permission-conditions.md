...
For conditions that are boolean combinations of simple checks (time, block, delegated sub-conditions, literal comparisons), you often don't need bespoke code: [`RuledCondition`](/common/ruled-condition.md) lets you express the logic as a data-driven rule list. Reusable ready-made conditions live in the [condition library](/helpers/index.md).

## See also

- [The permission system](/core/permissions.md) — where conditions are consulted.
- [RuledCondition](/common/ruled-condition.md) — declarative rule engine for building conditions.
