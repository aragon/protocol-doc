...
**Abstract contract** · [`src/common/plugin/extensions/proposal/Proposal.sol`](https://github.com/aragon/core/blob/f7c7508f4ceb2b685ee037ffe87df17340fc4aef/src/common/plugin/extensions/proposal/Proposal.sol)

**Author:** Aragon X - 2022-2024

**Inherits:** [`IProposal`](./IProposal.md), `ERC165`

An abstract contract containing the traits and internal functionality to create and execute proposals
