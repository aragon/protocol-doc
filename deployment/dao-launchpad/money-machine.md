...
A worked, illustrative example, not a production system, of what the [launchpad's one-shot factory](/deployment/dao-launchpad.md) and the [Capital Router](/plugins/capital-router.md) let you build together. It's the single best tour of the Capital Router in action.
...
Two things make it instructive: it deploys through the [correct-from-genesis factory](/deployment/dao-launchpad.md#correct-from-genesis), and it reuses most of the Capital Router while adding a few *custom* pieces, the clearest demonstration of how the framework is meant to be extended.
...
- [DAO Launchpad](/deployment/dao-launchpad.md) — the workbench and the one-shot factory pattern.
