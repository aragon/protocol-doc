...
- Want to try it? [A hands-on tour of OSx](/guides/hands-on-tour.md) stands up a DAO and makes it act, in one short Foundry test.
- Ready to launch one properly? [Deploy your first DAO](/guides/deploy-a-dao.md) hands control to a governance plugin from the first block.
