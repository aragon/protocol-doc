...
```sh
git clone --recurse-submodules https://github.com/aragon/osx-plugin-template-foundry.git my-plugin
cd my-plugin
make init   # installs dependencies and wires the remappings; `forge build` then works
```
